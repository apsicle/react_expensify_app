...
test('should remove expense from firebase', (done) => {
    const store = createMockStore(defaultAuthState); // we need to create store with a prop on state because startRemoveExpense queries it.
